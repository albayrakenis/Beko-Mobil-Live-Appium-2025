...
Feature: Ödeme İşlemleri
  ...
  Scenario: Sipariş Özeti Kontrolü
    ...
    Then I wait "urun toplami" element
    Then I wait "kargo ucreti" element
    Then I wait "toplam tutar" element
    Then I check total amount calculation is correct
    Then I wait "taksit tutari" element when installment selected
