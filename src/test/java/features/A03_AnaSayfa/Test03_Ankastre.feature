Feature: Ana sayfa kontrolleri
  ...
  Scenario Outline: Test03- Ankastre kategorisinde olmasi gereken basliklarin kontrolu
    ...
    Then I wait "Ankastre Aspiratorler;Ankastre Text;Ankastre Bulasik Makineleri;Ankastre buzdolabi;Ankastre Davlumbaz" elements
    Then I wait "Ankastre Firin;Ankastre Mikrodalgalar;Ankastre Ocak;Ankastre Set" elements
